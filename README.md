...
[Releases](https://github.com/sevenc-nanashi/filter_effect_toggle.aux2/releases/latest)から`filter_effect_toggle-v{{version}}.au2pkg.zip`をダウンロードし、AviUtl2のプレビューにドラッグ&ドロップしてください。
